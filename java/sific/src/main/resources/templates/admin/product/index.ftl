  ...
  layui.use(['table', 'layer'], function () {
    ...
    table.render({
      ...
      , cols: [[
        ...
        , { field: 'class_name_type', title: '类型'}
    ...
    table.on('toolbar(tableTool)', function(obj){
      ...
      switch(obj.event){
        ...
        case 'getCheckLength':
          ...
          member_del(str,'/product/del','/product/index');
          return true;
        case 'getCheckData':
          member_edit('编辑','/product/edit','/product/index',-1,'1000','800');
          break;
      }
    });
    ...
    table.on('tool(tableTool)', function (obj) {
      var data = obj.data;
      if (obj.event === 'del') {
        member_del(data.fid,'/product/del','/product/index')
      }else if (obj.event === 'edit') {
        member_edit('编辑','/product/edit','/product/index',data.fid,'1000','800')
      }
    });
